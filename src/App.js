...
const options = {
  ...
  languages: [
    ...
    {value: "ta", label:"Tamil",icon:"Tamil"},
    {value: "ml", label:"Malayalam",icon:"Malayalam"},
    {value: "kn", label:"Kannada",icon:"Kannada"},
    {value: "te", label:"Telugu",icon:"Telugu"},
    {value: "mr", label:"Marathi",icon:"Marathi"},
  ]
};

const topLocations = [
  { name: "Munnar, Kerala", value: "Munnar/Kerala" },
  { name: "Delhi, India", value: "Delhi/India" },
  { name: "Mahabalipuram, Chennai", value: "Mahabalipuram/Chennai" },
  // add more top locations as needed
];

const defaultValues = {
  destinationCountry: "TamilNadu",
  budget: "500 INR",
...
const Main = ({ loading, response, handleSubmit, handleChange, email }) => (
  <MainContent>
    <Title>🚂 TravelWiz ✈️</Title>
    {!response && <Subtitle>Fill the form to generate your Travel plan</Subtitle>}
...
const ResponseData = ({ response }) => {
  return (
    <ResponseContainer>
      <ResponseTitle>
        <span role="img" aria-label="emoji"></span> Your personalized travel plan.
      </ResponseTitle>
      <ResponseText>
      ...
      <Container>
        ...
        <Panel>
          <FormContainer onSubmit={handleSubmit}>
            ...
            <Input
              type="text"
              placeholder="e.g. Sabarimala/Kerala, Bangalore, Delhi, Gujarat etc."
            ...
            <FormRow>
              <FormGroup>
                ...
                <Input
                  type="text"
                  placeholder="e.g. 500 INR, 1000 INR, etc."
                  id="budget"
                  name="budget"
                  value={values.budget}
                  onChange={handleChange}
